...
# Caminho shapefile
shapefile_path = "C:/Users/Gabriel de Lima/DIO/Atlas_Topographic/EspinhoBnovo.shp"
...
for index, row in gdf.iterrows():
    ...
    if elevation > 260:  # Apenas elevações maiores do que 260 metros
...
output_file_path = os.path.join(os.path.expanduser('~'), 'Desktop', 'coordenadasEspinhoB.txt')
...
print(f"Coordenadas das elevações acima de 260 metros foram salvas em: {output_file_path}")
